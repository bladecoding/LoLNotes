...
namespace LoLNotes.Gui
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.TopChampsBox.Size = new System.Drawing.Size(98, 17);
        	this.TopChampsBox.TabIndex = 2;
        	this.TopChampsBox.Text = "最常使用英雄";
        	...
        	this.StatsBox.Size = new System.Drawing.Size(74, 17);
        	this.StatsBox.TabIndex = 1;
        	this.StatsBox.Text = "玩家資訊";
        	...
        	this.RecentGamesBox.Size = new System.Drawing.Size(74, 17);
        	this.RecentGamesBox.TabIndex = 0;
        	this.RecentGamesBox.Text = "對戰記錄";
        	...
        	this.ModuleGroupBox.Text = "模塊解析器";
        	// 
        	// MirrorRadio
        	// 
        	...
        	this.LeaveCheck.Size = new System.Drawing.Size(110, 17);
        	this.LeaveCheck.TabIndex = 7;
        	this.LeaveCheck.Text = "移除中離終結者";
        	...
        	this.DevCheck.Size = new System.Drawing.Size(86, 17);
        	this.DevCheck.TabIndex = 6;
        	this.DevCheck.Text = "開發者模式";
        	...
        	this.DebugCheck.Size = new System.Drawing.Size(50, 17);
        	this.DebugCheck.TabIndex = 1;
        	this.DebugCheck.Text = "偵錯";
        	...
        	this.TraceCheck.Size = new System.Drawing.Size(50, 17);
        	this.TraceCheck.TabIndex = 0;
        	this.TraceCheck.Text = "追蹤";
        	...
        	this.DatabaseGroupBox.Text = "資料庫";
        	// 
        	// ExportButton
        	// 
